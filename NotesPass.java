...
class NotesPass {
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            // Create an instance of NotesPass
            // NotesPass notesPass = new NotesPass();
    ...
    JFrame frame;
    JLabel image = new JLabel(new ImageIcon("lock.png"));
...
class PasswordManager implements ActionListener {
    ...
    public static void ContainerGUI(Container conn) {
        ...
        conn.setBackground(Color.getHSBColor(0, 240, 0));
        conn.setLayout(null);
    }
    ...
    public void GUIButtonsSetting(JButton btn) {
        ...
        btn.setCursor(crs);
        Font fn = new Font("SANS_SERIF\t", Font.BOLD, 15);
        btn.setFont(fn);
    }
    ...
    public void StoringGUI() {
        ...
        ContainerGUI(conn2);
        Font fn = new Font("SANS_SERIF\\t", Font.BOLD, 20);
